...
export const defaultSequences: SequenceStep[] = [
  ...
  { id: '7', type: 'follow_up', label: 'Follow-up message 2', enabled: false, order: 7 },
  { id: '8', type: 'follow_up', label: 'Follow-up message 3', enabled: false, order: 8 },
  { id: '9', type: 'follow_up', label: 'Follow-up message 4', enabled: false, order: 9 },
  { id: '10', type: 'follow_up', label: 'Follow-up message 5', enabled: false, order: 10 },
];
